...
with st.expander("➕ ลงทะเบียนทรัพย์สินใหม่"):
    with st.form("add_asset_form", clear_on_submit=True):
        ...
        with col1:
            ...
            input_date = st.date_input("วันที่ซื้อ", value=datetime.now(), format="DD/MM/YYYY")
        ...
        if submit:
            ...
            if input_sn:
                ...
                new_row = pd.DataFrame([{
                    ...
                    "Model Name (ชื่อรุ่น)": str(input_model), # เพิ่มตัวแปรนี้เข้าไปแล้วครับ
                ...
                try:
                    ...
                    conn.update(worksheet="Asset Management", data=df_updated)
